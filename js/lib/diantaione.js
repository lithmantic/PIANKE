define([],function(){
	...
	Factory.prototype = {
		...
		init:function(){
            ...
            // 设置样式
			name.style.cssText = 'width:242px;height:24px;left:20px;line-height:22px;font-size:24px;position:absolute;';
			infor.style.cssText = 'width:242px;height:13px;left:20px;line-height:13px;font-size:13px;position:absolute;top:36px;';
			price.style.cssText = 'display:block;width:242px;height:12px;left:20px;font-size:12px;position:absolute;bottom:0px;';
